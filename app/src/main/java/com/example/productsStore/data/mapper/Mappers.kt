...
fun ProductDetailsApi.toEntity(id: Int) = ProductDetailsEntity(id, title, description, rating, price, weight, availabilityStatus, warrantyInformation)
fun ProductDetailsEntity.toDomain(isIrrelevantInfo: Boolean) = ProductDetails(title, description, rating, price, weight, availabilityStatus, warrantyInformation, isIrrelevantInfo)